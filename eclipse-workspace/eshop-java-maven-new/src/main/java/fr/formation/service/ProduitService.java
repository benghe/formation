...
public class ProduitService {
	private IProduitDao daoProduit = new ProduitDaoSql();
...
//		if (produit.getLibelle() == "") {
		...
		if (produit.getLibelle() == null || produit.getLibelle().equals("")) {
			//ERREUR
			throw new LibelleVideException();
		}
		
		//Deuxième règle : prix > 0
		if (produit.getPrix() == null || produit.getPrix().compareTo(new BigDecimal(1)) == -1) {
